...
// constinit can be used only in static/global scope
const int val1 {33}; // known at compile time
constexpr int val2{34}; // known at compile time
...
int main(){
    ...
    //constinit double height{1.72}; // can't be used in local scope of functions;
